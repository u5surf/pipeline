...
func TestGetTaskSpec_Embedded(t *testing.T) {
	...
	gt := func(n string) (v1alpha1.TaskInterface, error) { return nil, xerrors.Errorf("shouldn't be called") }
	taskMeta, taskSpec, err := GetTaskData(tr, gt)
...
func TestGetTaskSpec_Error(t *testing.T) {
	...
	gt := func(n string) (v1alpha1.TaskInterface, error) { return nil, xerrors.Errorf("something went wrong") }
	_, _, err := GetTaskData(tr, gt)
	if err == nil {
